...
[
 ...
 {
  "jour": 6,
  "titre": "Cargèse, Porto et les calanques de Piana",
  "contenu": "<p>Départ vers 08h30 pour U Portu (Porto). La journée commencera par une excursion aux Sanguinaires, un chapelet d'îles au nom étrange et d'une rare beauté (votre guide vous donnera la surprenante explication de ce nom inquiétant). Arrivés sur la presqu'île de « A Parata », vous en ferez le tour à pied pour  apprécier au mieux la majesté du paysage. Autres petits points d'intérêts sur le site, un centre d'interprétation des Sanguinaires et un artisan nougatier à la réputation bien établie. </p> <p> Puis départ pour Carghjese (Cargèse), le «village grec»: fondé au XVème siècle par des grecs fuyant l'invasion de leur pays par les turcs, ce village est connu non seulement pour la beauté du site, mais aussi pour ses deux églises se faisant face: l'une de rite latin, l'autre de rite orthodoxe grec.  Mais le plus beau reste à venir, car ensuite, vous allez découvrir un des fleurons de l’île de beauté: d'abord, le village de Piana et ses magnifiques maisons aux murs de porphyre, puis ce sera le belvédère de Vistale où vous aurez à vos pieds tout le golfe de U Portu (Porto).   La suite du trajet vous amènera au pied de la tour de «Turghju», et enfin dans les Calanche de Piana. Ici vous pénétrez dans un site à la beauté stupéfiante, classé  «patrimoine mondial» par l’UNESCO : une route accrochée à des falaises traversant un paysage grandiose de rochers rouges qu’il serait vain  d’essayer de décrire. Laissons plutôt parler Guy De Maupassant: «…peut-être n’est-il  de par le monde rien de plus étrange que ces Calanche de Piana, rien de plus curieusement ouvragé par dame nature…ces surprenants rochers semblent des arbres des plantes, des bêtes, des hommes, des monuments, des moines en robe, des diables cornus, des oiseaux démesurés, tout un peuple monstrueux, une ménagerie de cauchemar pétrifiée par le vouloir de quelque dieu extravagant ». Une petite halte dans un café accroché à la paroi rocheuse vous fera encore mieux réaliser l’extraordinaire folie minérale  que sont les Calanche.</p><p> Mais vous n’êtes pas au bout de  l’éblouissement, la fin du trajet vous fera découvrir U Portu,  (Porto) niché au fond d’un golfe splendide et romantique à souhaits: là encore, écoutons  plutôt Maupassant : « …et soudain je découvris  le golfe de Porto, ceint tout entier  d’une  muraille sanglante de  granit rouge reflétée  dans une  mer d’azur… ».</p>",
  "photo": ""
 },
 {
  "jour": 7,
 ...
 {
  "jour": 8,
  "titre": "La spelunca, le Niolo, Corte",
  "contenu": "<p>Départ pour Bastia, via la «Spelunca». Un panorama magnifique vous y attend : devant vous un impressionnant paysage de montagnes et forêts entrelacées où vous allez pénétrer. Très vite la route grimpe à travers les montagnes, passe entre les parois de granit, les  châtaigneraies et les pins pour déboucher sur les fameuses gorges de A Spelunca. Là, les montagnes se dressent en forme de colonnes et de cônes jaillissant presque verticalement de la végétation luxuriante de la vallée : « une tempête de montagnes » (Guy de Maupassant). C'est là dans cette région que se trouve la forêt d’Aïto (Aitone) connue pour ses fameux pins Lariccii (plus de 50m de hauteur) et où vécut un célèbre bandit dont votre guide vous contera  la fabuleuse (et tragique) histoire. </p><p>La suite du trajet vous fera franchir le col de U Verghju (Vergio), le plus haut de Corse, puis traverser U Niolu, (Le Niolo) la région la plus rebelle de Corse, un pays de bergers qui bien souvent se transformèrent en guerriers redoutables, et redoutés,  par  les divers occupants de la Corse. Vous ferez d’ailleurs un petit arrêt dans le village où furent pendus il y a trois siècles les héros corses (dont des enfants de 11 ans) qui avaient résisté à l’invasion française. Ensuite vous emprunterez le défilé de A Santa, taillé dans le roc, et offrant  des à-pic impressionnants. Le repas de midi (inclus) se prendra au « Pont du diable » dans un petit restaurant de montagne, connu de tous les habitants de la région pour la simplicité et la saveur de sa cuisine authentique. </p> <p>Puis ce sera la visite de Corti (Corte)  «La Capitale»: chargée d’histoire et chère au cœur des Corses, Corti fut la capitale de la Corse au temps heureux de l’indépendance. Mais c’est aussi une jolie petite ville qui saura vous séduire avec sa petite citadelle et ses ruelles  étroites. Vous visiterez également le musée d’arts et traditions populaires, crée  il y a huit ans et le «nid d’aigle » de la citadelle. Vous gagnerez ensuite Bastia, en passant par le site historique de Ponte-Novu, théâtre d’une bataille décisive et sanglante qui coûta son indépendance à la Corse. Enfin arrivée à Bastia, et installation à votre hôtel situé face au port de Toga et à 6 minutes à pied du centre ville. Souper libre. (131 Kms).</p>",
  "photo": ""
 },
 {
  "jour": 9,
 ...
 {
  "jour": 11,
  "titre": "Les «Vieux villages de Balagna»",
  "contenu": "<p>La Balagna, surnommée le jardin de la Corse,  fut longtemps la plus riche région de l’île. Tout y est plus doux qu’ailleurs : le relief, constitué de collines, et le climat, qui permet aux palmiers et agaves de pousser. D’innombrables villages parsèment ce jardin de la Corse. Vous aurez l’occasion de visiter plusieurs d’entre eux et de tomber sous leur Charme : en premier lieu, le plus vieux village de Corse (classé parmi les 10 plus beaux villages de France) perché sur un piton rocheux, et aux ruelles voûtées. De là haut on a une vue saisissante sur toute la Balagna.  Ensuite, arrêt au « village d’artisans » (qui faillit disparaître il y a 20 ans, et qui doit sa renaissance à l’installation de nombreux artisans). Enfin, visite de  L’Isula-rossa (Ile Rousse) fondée par Pasquale de Paoli, héros de l’indépendance corse, et retour à l’Algaiola. Pour ceux qui auraient envie de faire une petite promenade à pied, ils pourront rentrer à l’hôtel par un petit sentier pédestre (4 kilomètres, 1h45 environ). Souper inclus. (24 Kms).</p>",
  "photo": ""
 },
 {
  "jour": 12,
 ...
 {
  "jour": 13,
  "titre": "Les gorges de l'Ascu",
  "contenu": "<p>Votre dernière journée en Balagne sera consacrée à la visite d’un village et d’une vallée longtemps isolés : Ascu. Vous vous engagerez d’abord dans les gorges d'Ascu qui mènent au village du même nom. Le village est un des  plus isolés de Corse et est défendu par un défilé impressionnant. Celui-ci fut le théâtre d’une sanglante bataille entre les villageois et les envahisseurs sarrasins qui furent écrasés (au sens propre du terme). Votre guide vous contera cette sanglante bataille. Connu dans toute l’île pour son « Sage », sa manne, ses curieuses ruches et sa faune (Gypaète barbu, mouflon, sitelle...), le village est également un centre de villégiature, car il possède une petite station de ski, au pied de la plus haute montagne de Corse, le Monte Cintu (2.710 mètres d’altitude). Votre repas de midi (inclus) se prendra dans une petite auberge offrant une vue superbe sur la vallée d'Ascu et les aiguilles de Popolasca (2.180 mètres) plus hautes que celles de Bavella (1.791 mètres) et pourtant quasiment inconnues des touristes. </p> <p>Sur la route du retour, vous visiterez un autre magnifique village, tout empierré, et sa source cachée. Remarquablement restauré, il offre également une vue imprenable sur la Balagne et le massif du Monte Padru (2.400 mètres). Retour à l’Algaiola vers 18H00 (116 Kms). Souper libre.  </p>",
  "photo": ""
 },
 {
  "jour": 14,
